(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.experimentalTag": { zh: "实验", en: "EXP" },
        "smart.imageModelObserved": { zh: "服务端实际模型", en: "Server-observed model" },
        "smart.imageModelUnconfirmed": { zh: "2.5 选择未被服务端确认（返回别名），实际模型以服务端路由为准", en: "2.5 choice not confirmed by server (alias returned); actual model is server-routed" },
