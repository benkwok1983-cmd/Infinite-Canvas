---
name: mono-color
description: Generate original one-ink or controlled two-ink editorial images from any theme, sentence, article idea, object,
  or reference photo. Always use this skill when the user asks for 单色海报、双色印刷、单色调视觉、蓝色/绿色孔版印刷、risograph、网点照片、复古或当代编辑排版、zine
  poster, monochrome editorial poster, duotone print, or asks to use the mono-color style. It uses an adaptive white, gray,
  or pale-beige substrate, no more than two printing inks, active negative space, terse human language, and strong serif/grotesk/mono
  typography without making retro styling the default or copying a source composition, wording, logo, or artwork. Produce
  both the final generation prompt and the generated raster image unless the user explicitly asks for prompt only.
variants:
- id: one-cobalt
  label: 单墨 · Cobalt (#2148B8)
  prompt: 'Print with exactly ONE ink: Cobalt #2148B8 halftone on Neutral White substrate. All pictorial and typographic elements
    use only this ink; moods: knowledge, city, music.'
- id: one-royal-blue
  label: 单墨 · Royal Blue (#2058D4)
  prompt: 'Print with exactly ONE ink: Royal Blue #2058D4 halftone on Neutral White substrate. All pictorial and typographic
    elements use only this ink; moods: youth, fashion, movement.'
- id: one-botanical-green
  label: 单墨 · Botanical Green (#008A4B)
  prompt: 'Print with exactly ONE ink: Botanical Green #008A4B halftone on Neutral White substrate. All pictorial and typographic
    elements use only this ink; moods: botanical, ecology, archive.'
- id: one-mint-green
  label: 单墨 · Mint Green (#5EB783)
  prompt: 'Print with exactly ONE ink: Mint Green #5EB783 halftone on Neutral White substrate. All pictorial and typographic
    elements use only this ink; moods: observation, nature, quiet.'
- id: one-terracotta-orange
  label: 单墨 · Terracotta Orange (#C65F38)
  prompt: 'Print with exactly ONE ink: Terracotta Orange #C65F38 halftone on Neutral White substrate. All pictorial and typographic
    elements use only this ink; moods: travel, summer, food.'
- id: one-signal-red
  label: 单墨 · Signal Red (#C83232)
  prompt: 'Print with exactly ONE ink: Signal Red #C83232 halftone on Neutral White substrate. All pictorial and typographic
    elements use only this ink; moods: declaration, music, event.'
- id: one-aubergine
  label: 单墨 · Aubergine (#63365F)
  prompt: 'Print with exactly ONE ink: Aubergine #63365F halftone on Neutral White substrate. All pictorial and typographic
    elements use only this ink; moods: literature, cinema, night.'
- id: one-charcoal
  label: 单墨 · Charcoal (#30343A)
  prompt: 'Print with exactly ONE ink: Charcoal #30343A halftone on Neutral White substrate. All pictorial and typographic
    elements use only this ink; moods: architecture, photography, research.'
- id: two-powder-blue-signal-red
  label: 双墨 · Powder Blue + Signal Red
  prompt: 'Controlled TWO-INK print: dominant plate Powder Blue #9EB8D3 carries 70-85% of the printed area; accent plate Signal
    Red #C83232 carries 15-30% for dates, annotations, or selected objects; substrate Neutral White.'
- id: two-cobalt-terracotta-orange
  label: 双墨 · Cobalt + Terracotta Orange
  prompt: 'Controlled TWO-INK print: dominant plate Cobalt #2148B8 carries 70-85% of the printed area; accent plate Terracotta
    Orange #C65F38 carries 15-30% for dates, annotations, or selected objects; substrate Neutral White.'
- id: two-botanical-green-oxblood
  label: 双墨 · Botanical Green + Oxblood
  prompt: 'Controlled TWO-INK print: dominant plate Botanical Green #008A4B carries 70-85% of the printed area; accent plate
    Oxblood #8F3434 carries 15-30% for dates, annotations, or selected objects; substrate Neutral White.'
- id: two-charcoal-signal-red
  label: 双墨 · Charcoal + Signal Red
  prompt: 'Controlled TWO-INK print: dominant plate Charcoal #30343A carries 70-85% of the printed area; accent plate Signal
    Red #C83232 carries 15-30% for dates, annotations, or selected objects; substrate Neutral White.'
- id: two-electric-blue-carbon
  label: 双墨 · Electric Blue + Carbon
  prompt: 'Controlled TWO-INK print: dominant plate Electric Blue #173AE3 carries 70-85% of the printed area; accent plate
    Carbon #242321 carries 15-30% for dates, annotations, or selected objects; substrate Neutral White.'
- id: two-mint-green-charcoal
  label: 双墨 · Mint Green + Charcoal
  prompt: 'Controlled TWO-INK print: dominant plate Mint Green #5EB783 carries 70-85% of the printed area; accent plate Charcoal
    #30343A carries 15-30% for dates, annotations, or selected objects; substrate Neutral White.'
- id: duotone-photograph
  label: 双墨 · 照片网点版画
  prompt: 'Convert the supplied reference photograph into a two-ink halftone reprographic print: convert photographic tones
    to halftone dots of the dominant ink, keep subject identity, substrate Pale Beige.'
---
